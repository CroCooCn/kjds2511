...
//    private String storeBrokerageStatus;
    ...
    @Min(value = 0, message = "一级返佣比例请在0-100中选择")
    @Max(value = 100, message = "一级返佣比例请在0-100中选择")
    private Integer storeBrokerageRatio;

    @ApiModelProperty(value = "二级返佣比例")
    @NotNull(message = "二级返佣比例 不能为空")
    @Min(value = 0, message = "二级返佣比例在0-100中选择")
    @Max(value = 100, message = "二级返佣比例在0-100中选择")
    ...
    @Min(value = 0, message = "是否展示分销气泡只能选择0-1")
    @Max(value = 1, message = "是否展示分销气泡只能选择0-1")
