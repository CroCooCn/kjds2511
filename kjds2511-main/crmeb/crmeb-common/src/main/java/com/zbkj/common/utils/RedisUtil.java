    ...
    public void delete(String... key) {
        if (key != null && key.length > 0) {
            if (key.length == 1) {
                ...
                getRedisTemplate().delete((java.util.Collection<String>) CollectionUtils.arrayToList(key));
            }
        }
    }
    ...
    public void secondDelete(String... key) {
        if (key != null && key.length > 0) {
            if (key.length == 1) {
                ...
                getSecondRedisTemplate().delete((java.util.Collection<String>) CollectionUtils.arrayToList(key));
            }
        }
    }
}
